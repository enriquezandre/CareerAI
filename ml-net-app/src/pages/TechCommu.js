  ...
  return (
    ...
    <div className="Content">
      <div className='topic'>
        ...
        <InputButton
            number={values.technical_Communication || 0} // Pass the value from the context state as the 'number' prop
            onIncrement={() => {
              if (values.technical_Communication < 10) {
                handleInputChange({ target: { value: parseInt(values.technical_Communication || 0) + 1 } });
              }
            }}
            onDecrement={() => {
              if (values.technical_Communication > 0) {
                handleInputChange({ target: { value: parseInt(values.technical_Communication || 0) - 1 } });
              }
            }}
          />
